...
import { iconArray } from "../Types";

const Sidebar: React.FunctionComponent = () => {
  const mainLinks: iconArray[] = [
    {
  ...
  const secondaryLinks: iconArray[] = [
    {
  ...
  const subscriptionLinks: iconArray[] = [
    {
  ...
  return (
    <div className="w-60 bg-[#212121] pr-0 overflow-auto pb-8 sidebar">
