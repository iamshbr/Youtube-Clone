...
const Watch: React.FunctionComponent = () => {
  ...
  const currentPlaying = useAppSelector((state: RootState) => state.youtubeCloneApp.currentPlaying);
  const recommendedVideos = useAppSelector((state: RootState) => state.youtubeCloneApp.recommendedVideos);
          ...
          <div className="flex w-full" style={{ height: "92.5vh" }}>
            <div className="flex gap-y-10 gap-x-5 p-7 mx-20 mr-0 w-full overflow-auto">
              <div style={{ maxWidth: "800px" }}>
                <div className="rounded-lg" style={{ overflow: "hidden", float: "left", position: "relative" }}>
                  <iframe
                    width="800"
                    height="502"
